<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSuperVisorProfile.aspx.cs" Inherits="GucPostGrad.ViewSuperVisorProfile" %>
...
<body style="text-align: center; background-color:#1E1E1E; color:white; font-family:Calibri">
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="MyProfile" runat="server" CellPadding="4" ForeColor="Black" Width="40%" BackColor="#CCCCCC" BorderColor="Black" BorderStyle="Solid">
