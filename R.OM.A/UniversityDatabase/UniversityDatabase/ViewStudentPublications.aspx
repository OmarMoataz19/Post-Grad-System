<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewStudentPublications.aspx.cs" Inherits="GucPostGrad.ViewStudentPublications" %>
...
<body style="text-align: center; background-color:#1E1E1E; color:white; font-family:Calibri">
    ...
    <form id="form1" runat="server"><h2>
        <asp:Label ID="Label1" runat="server" Text="Student Publication(s)"></asp:Label>
        </h2>
        <div>
        </div>
        <asp:GridView ID="Publications" runat="server" CellPadding="4" ForeColor="Black" Width="60%" BackColor="#CCCCCC" BorderColor="Black" BorderStyle="Solid">
