<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View Theses.aspx.cs" Inherits="UniversityDatabase.View_Theses" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>All Attended Theses</title>
</head>
<body style="text-align: center; background-color:#1E1E1E; color:white; font-family:Calibri">
    ...
    <h1>All Attended Theses</h1>
    <form id="attendedTheses" runat="server">
        ...
        <asp:Button ID="returnHome" runat="server" Text="Return to home page" OnClick="returnHome_Click" style="margin-top: 20px;"/>
    </form>
</body>
</html>
